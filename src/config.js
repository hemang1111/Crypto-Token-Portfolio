...
export const gridPageLimit = 10;
export const ApiPageLimit = 50;
...
export const listData = async (url, sendParams = true, per_page = 250, page = 1, header = {}) => {
    try {
...
*/
export const toFixedFloat = (value, cut = 8) => {
    try {
